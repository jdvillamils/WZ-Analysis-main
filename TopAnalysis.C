            ...
            if(passGRL) //Pass the Good Run List
            {
                ...
                if(hasGoodVertex)
                {
                    ...
                    if(goodlep_n==3)
                    {
                        ...
                        if(lep_type[goodlep1] == lep_type[goodlep2] && lep_charge[goodlep1] == -lep_charge[goodlep2]){goodlepa=goodlep1, goodlepb=goodlep2, goodlepc=goodlep3;}
                        if(lep_type[goodlep1] == lep_type[goodlep3] && lep_charge[goodlep1] == -lep_charge[goodlep3]){goodlepa=goodlep1, goodlepb=goodlep3, goodlepc=goodlep2;}
                        if(lep_type[goodlep2] == lep_type[goodlep3] && lep_charge[goodlep2] == -lep_charge[goodlep3]){goodlepa=goodlep2, goodlepb=goodlep3, goodlepc=goodlep1;}
